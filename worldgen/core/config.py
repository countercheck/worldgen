...
class WorldConfig:
    ...
    # What deep alluvium adds to a hex's food value, as a multiple of its band's base.
    # A floodplain is the best farmland there is and the reason river valleys are where
    # people are: silt renews the soil faster than cropping strips it, so the same cover
    ...
    # desert into a granary — dry silt is still dry.
