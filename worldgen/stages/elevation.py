...
def apply_continent_falloff(
    ...
    # Blend towards a shallow seabed, not towards zero.  Dropping the border to elevation
    # 0 puts an abyss against the shore, and the whole descent has to happen across the
    # shelf, which is what made the coast a cliff whatever width it was given.  A seabed
    # just below sea level is both a shorter drop and a truer one — the sea floor near a
    # coast is shallow.
